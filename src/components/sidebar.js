...
export default function Sidebar() {
    return(
        ...
        <div className={styles.socialBar} style={animation.slideInUp}>
            ...
            <a title="LinkedIn" rel="noopener noreferrer" href="https://www.linkedin.com/in/patelpriyanshi/" target="_blank" className={styles.socialButton}><i className="fa fa-linkedin" style={{color:'#c4b6ab'}}></i></a>
