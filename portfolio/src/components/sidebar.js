...
export default function Sidebar() {
    return(
        ...
        <div className={styles.socialBar} style={animation.slideInUp}>
            ...
            <a title="Email" rel="noopener noreferrer" href="mailto: priyanshii.patel@mail.utoronto.ca" target="_blank" className={styles.socialButton}><i className="fa fa-envelope" style={{color:'#c4b6ab'}}></i></a>
        </div>
        </StyleRoot>
    )
}